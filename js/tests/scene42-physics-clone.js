// AUTO-GENERATED from Babylon-Lite lab/lite/src/lite/scene42.ts (esbuild, target es2017)
// Scene 42 — Physics Clone Pre-Step — tags: std, procedural, physics
// Run:  app.exe --prelude js/lite/index.js --script js/tests/scene42-physics-clone.js
...
async function main() {
  ...
  const sphere2 = cloneTransformNode(sphere);
