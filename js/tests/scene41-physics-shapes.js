// AUTO-GENERATED from Babylon-Lite lab/lite/src/lite/scene41.ts (esbuild, target es2017)
// Scene 41 — Physics Shape Debug Viewer — tags: std, procedural, physics
// Run:  app.exe --prelude js/lite/index.js --script js/tests/scene41-physics-shapes.js
...
function findPrimaryMesh(container, label) {
  const meshes = [];
...
async function loadShapeRows(engine) {
...
function createVisualMesh(row, color, x, suffix) {
  const mesh = cloneTransformNode(row.source);
...
function bindBodyShape(world, viewer, node, shape) {
...
function createHelper(parent, name, x, y, z, rx = 0, ry = 0, rz = 0) {
...
function createShapeRow(world, viewer, row) {
