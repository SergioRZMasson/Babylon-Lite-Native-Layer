// AUTO-GENERATED from Babylon-Lite lab/lite/src/lite/scene111.ts (esbuild, target es2017)
// Scene 111 — Light Selection Stress Test — tags: std, pbr, nme, procedural, shadow
// Run:  app.exe --prelude js/lite/index.js --script js/tests/scene111-light-selection.js
...
async function main() {
  ...
  pbrSphere.material = createPbrMaterial({
    baseColorTexture: createSolidTexture2D(engine, 0.15, 0.55, 1, 1),
