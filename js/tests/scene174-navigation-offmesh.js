// AUTO-GENERATED from Babylon-Lite lab/lite/src/lite/scene174.ts (esbuild, target es2017)
// Scene 174 - Navigation Off-Mesh Connections — tags: navigation, recast, wasm, offmesh
// Run:  app.exe --prelude js/lite/index.js --script js/tests/scene174-navigation-offmesh.js
...
async function main() {
  ...
  const cam = createArcRotateCamera(1.8, 1, 20, { x: 0, y: 1, z: 0 });
  scene.camera = cam;
  ...
  const staticMesh = (_a = scene.meshes.find((m) => m.name === "Cube-Mesh")) != null ? _a : scene.meshes[0];
  if (!staticMesh) {
