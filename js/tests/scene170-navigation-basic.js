// AUTO-GENERATED from Babylon-Lite lab/lite/src/lite/scene170.ts (esbuild, target es2017)
// Scene 170 - Navigation Basic — tags: navigation, recast, wasm
// Run:  app.exe --prelude js/lite/index.js --script js/tests/scene170-navigation-basic.js
...
async function main() {
  ...
  const agentSpawn = getClosestPoint(nav, { x: -2, y: 0.1, z: -1.8 });
