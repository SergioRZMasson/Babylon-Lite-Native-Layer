// AUTO-GENERATED from Babylon-Lite lab/lite/src/lite/scene43.ts (esbuild, target es2017)
// Scene 43 — Parametric Proximity Path — tags: std, procedural, thin-instances
// Run:  app.exe --prelude js/lite/index.js --script js/tests/scene43-parametric-proximity.js
...
function makeCirclePath(samples) {
  const pts = [];
...
function nearestBlock(blocks, p) {
  let best = null;
  let bestD2 = Infinity;
