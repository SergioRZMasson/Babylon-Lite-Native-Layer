// AUTO-GENERATED from Babylon-Lite lab/lite/src/lite/scene100.ts (esbuild, target es2017)
// Scene 100 — Physics Collision Event — tags: std, procedural, physics
// Run:  app.exe --prelude js/lite/index.js --script js/tests/scene100-physics-collision.js
...
async function main() {
  ...
  const sphereAggregate = createPhysicsAggregate(world, sphere, PhysicsShapeType.SPHERE, {
    mass: 1,
    restitution: 0.75
  });
  ...
  setPhysicsBodyCollisionEventsEnabled(world, sphereAggregate.body, true);
  onPhysicsCollision(world, (info) => {
    console.log("scene100 collision", info.type, info.impulse);
    canvas.dataset.collided = "true";
  });
