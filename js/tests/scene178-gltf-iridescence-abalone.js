// AUTO-GENERATED from Babylon-Lite lab/lite/src/lite/scene178.ts (esbuild, target es2017)
// Scene 178 - IridescenceAbalone glTF — tags: pbr, gltf, iridescence, env, skybox
// Run:  app.exe --prelude js/lite/index.js --script js/tests/scene178-gltf-iridescence-abalone.js
...
async function main() {
  ...
  const camera = createArcRotateCamera(1.2, 1.25, 1, { x: 0, y: 0, z: 0 });
  camera.fov = 0.7;
