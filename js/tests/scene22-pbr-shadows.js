// AUTO-GENERATED from Babylon-Lite lab/lite/src/lite/scene22.ts (esbuild, target es2017)
// Scene 22 — PBR Shadows — tags: pbr, shadow, procedural, multilight
// Run:  app.exe --prelude js/lite/index.js --script js/tests/scene22-pbr-shadows.js
...
async function main() {
  ...
  const ormTex = createSolidTexture2D(engine, 1, 0.9, 0);
  ...
  const btnStyle = "position:absolute;bottom:12px;padding:8px 16px;font:14px sans-serif;cursor:pointer;z-index:10;background:#333;color:#fff;border:1px solid #666;border-radius:4px;";
