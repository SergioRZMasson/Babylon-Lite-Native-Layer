// AUTO-GENERATED from Babylon-Lite lab/lite/src/lite/scene156.ts (esbuild, target es2017)
// Scene 156 — Manual Cross-Fade Animation — tags: std, procedural, anim
// Run:  app.exe --prelude js/lite/index.js --script js/tests/scene156-manual-cross-fade.js

const FRAME_RATE = 10;
const END_FRAME = 2 * FRAME_RATE;
const FADE_START_MS = 1e3;
