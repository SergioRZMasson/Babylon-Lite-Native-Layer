// AUTO-GENERATED from Babylon-Lite lab/lite/src/lite/scene57.ts (esbuild, target es2017)
// Scene 57 — Cutout Billboards — tags: sprites, billboards, depth
// Run:  app.exe --prelude js/lite/index.js --script js/tests/scene57-cutout-billboards.js

const CAMERA_POSITION = { x: 0, y: 1.05, z: -6 };
const CAMERA_TARGET = { x: 0, y: 0.75, z: 1 };
async function main() {
