// AUTO-GENERATED from Babylon-Lite lab/lite/src/lite/scene141.ts (esbuild, target es2017)
// Scene 141 — ESM Material Casters — tags: nme, standard, pbr, shadows
// Run:  app.exe --prelude js/lite/index.js --script js/tests/scene141-esm-material-casters.js
...
async function main() {
  ...
  pbrSphere.material = createPbrMaterial({
    ...
    ormTexture: createSolidTexture2D(engine, 1, 0.45, 0.2, 1),
