// AUTO-GENERATED from Babylon-Lite lab/lite/src/lite/scene83.ts (esbuild, target es2017)
// Scene 83 — NME Normals — tags: nme, procedural, normals, lighting
// Run:  app.exe --prelude js/lite/index.js --script js/tests/scene83-nme-normals.js

async function loadScene83BlockEmitter(className) {
  switch (className) {
    case "AddBlock":
