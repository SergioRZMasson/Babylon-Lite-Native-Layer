...
// Demonstrates selecting a single animation: glTF groups auto-play on add, so we stop
// all then play just the "Walk" clip. Skinning (joint sampling → bone palette → GPU
// skinning) runs natively in C++.
