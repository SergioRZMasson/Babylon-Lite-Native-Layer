// Babylon-Lite consumer demo — written exactly like a Babylon-Lite *web* scene.
//
// The only difference from a real @babylonjs/lite page is the missing
// `import { ... } from "@babylonjs/lite"` line: the prelude (js/lite/index.js)
// installs the same API on globalThis. Everything below is standard Babylon-Lite
// usage — but it renders through native C++/bgfx, with zero WebGPU.
