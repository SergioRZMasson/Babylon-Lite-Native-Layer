...
// (Samples/webgpu-cross-platform-app/assets/script/src/lite/scene200.ts) to our native
// Babylon-Lite API so the workload matches for a side-by-side comparison.
//
...
import { createEngine, createSceneContext, createArcRotateCamera, attachControl, addToScene, createHemisphericLight, loadHdrEnvironment, createSolidTexture2D, createTorus, createBox, createSphere, createGround, createPbrMaterial, createStandardMaterial, mat4Compose, setThinInstances, setThinInstanceColors, registerScene, startEngine } from "babylon-lite";
