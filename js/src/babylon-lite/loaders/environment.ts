...
import { utf8Decode } from "../internal.js";
import { ensureCached } from "../net.js";
...
export async function loadEnvironment(scene: any, url: any, options?: any) {
    await ensureCached(String(url));
    ...
    const json = JSON.parse(utf8Decode(bytes.subarray(8, p)));
...
export function loadHdrEnvironment(scene: any, url: any, options?: any) {
    return Promise.resolve();
}
